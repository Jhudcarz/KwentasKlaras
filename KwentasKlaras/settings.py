...
#             'NAME': os.getenv('DB_NAME', 'kwentasklaras'),
#             'USER': os.getenv('DB_USER', 'kwentasklaras'),
...
# Only validate PostgreSQL database configuration if not in local environment
if ENVIRONMENT != 'local':
...
CSRF_TRUSTED_ORIGINS = [
    "https://kwentasklaras-production-7b69.up.railway.app",
]
...
EMAIL_PORT = int(os.getenv('EMAIL_PORT', '587').replace('"', '').replace("'", ""))
...
if not TURNSTILE_SITE_KEY or not TURNSTILE_SECRET_KEY:
    raise ValueError("Turnstile site key and secret key must be set in environment variables")
